...
class FlatJsonSpec extends FreeSpec with JsonSpecUtil {
  "should ignore identical elements" in {
    Null          delta Null          jsonShouldEqual jEmptyObject
    fromBoolean(true)    delta fromBoolean(true)    jsonShouldEqual jEmptyObject
    fromInt(123)   delta fromInt(123)   jsonShouldEqual jEmptyObject
    jString("abc") delta jString("abc") jsonShouldEqual jEmptyObject
    jEmptyObject   delta jEmptyObject   jsonShouldEqual jEmptyObject
    fromValues(Nil)    delta fromValues(Nil)    jsonShouldEqual jEmptyObject
